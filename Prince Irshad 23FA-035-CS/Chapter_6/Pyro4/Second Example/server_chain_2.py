...
# Define the logical identifier/name of this specific current server node (Node 2)
current_server = "2"
# Define the identifier of the next server node that this server will forward messages to (Node 3)
next_server = "3"
...
# Create an instance of our Chain class, passing this server's identity ("2") and its target next server ("3")
...
# Print a confirmation message to the terminal showing that Server 2 has been successfully initialized and started
